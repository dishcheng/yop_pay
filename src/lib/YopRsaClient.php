...
//        dd($serverUrl);
    ...
    {
//        echo '----------'.$content['header']['x-yop-sign'].'--------------';
////        print_r($content);
////        echo '<br><br>';
//        if(empty($content['header']['x-yop-sign'])) {
//            $setCookieexists = stripos($content['content'],'Set-Cookie: ');
//            $setCookie =  stripos($content['content'],'Set-Cookie: ')-stripos($content['content'],'x-yop-sign: ')-11;
////            echo '333';
////            echo $setCookie;
////            echo '333';
////            return $content['content'];
//            $start = stripos($content['content'],'x-yop-sign: ')+11;
//            $end = stripos($content['content'],'{')-stripos($content['content'],'x-yop-sign: ')-11;
//
//            if(!empty($setCookieexists)){
//                $end = $setCookie;
//            }
//            $sign =  substr($content['content'],$start,$end);
//
////            echo '<br>------';
////            echo $sign;
////            echo '-------<br>';
//            $start = stripos($content['content'],'{');
//            $end = strripos($content['content'],'}');
//            $signStr =  substr($content['content'],$start,$end);
//            $response = new YopResponse();
//            $jsoncontent = json_decode($signStr);
//        }else{
